...
SCRIPT_PATH = Path(__file__).resolve().parent.parent / "assets" / "blender_scripts" / "game_ready_selftest.py"
...
def test_game_ready_pass_centres_origin_packs_uvs_and_one_material(tmp_path):
